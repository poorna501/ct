...
Kruskal.prototype.edge = function() {
	...
	if (edgesMap[fromEdge + "-" + toEdge] == undefined) {
		...
		var flag = false; 
		console.log("in DisCon before " + this.vertices);
...
function display_Prompt() {
	alertify.confirm("The <r>edge</r> between <r>"+ $("#fromID .active").text() +"</r> and <r>"+ $("#toID .active").text() 
			+ "</r> is already exists. <br/>Do u Want to <r>chage the weight of the Edge</r>.", function() {
...
Kruskal.prototype.testing = function() {
	...
	this.cmd("Step");
	this.cmd("SETEDGEALPHA", this.vertices[fromEdge], this.vertices[toEdge], "#e62e00");
	this.cmd("Step");
...
Kruskal.prototype.start = function() {
	this.commands = new Array();
	console.log("Hello Start Btn");
	this.cmd("CreateLabel", this.nextIndex++, "Sort the Edge", 475, 40);
