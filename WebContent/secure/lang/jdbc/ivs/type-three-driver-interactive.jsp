								...
								typing(".introjs-tooltiptext > ul li:last", text, function() {
									appendUserButton('.introjs-tooltipbuttons',function() {
										svgLineTopAndBottom("#svgParent","#DLApi","#ovalShape" ,"line4","grey", "bottom","top", "left", "left", "", function() {
											$('.introjs-tooltiptext > ul').append("<li></li>");
											$('.introjs-tooltip').scrollTo('.introjs-tooltipbuttons',{duration:'slow', offset :{left:'left', top:'top' }});
											var text = " The DBEngine than queries the database by passing the query to the database";
											typing(".introjs-tooltiptext > ul li:last", text, function() {
												appendUserButton('.introjs-tooltipbuttons',function() {
...
function pipeLineFromAptToServer() {
	tube2("#DLApi", "#middleWare", "tubeLine21");
	tube1("#DLApi", "#middleWare", "tubeLine22");
	setTimeout(function() {
		pipeLineText("#DLApi", "#middleWare", 0);
		setTimeout(function() {
...
function client() {
 ...
 function middleWare() {
	...
	zoomInEffect('#middleWare',function() {
		/* $('#line113').css('opacity', '');
		svgText('#line113', 'Database layer'); */
		var text = "<span class='start-text'><b>Middleware Server</b> : The <y>middleware-net-server</y><span class='end-text'> translates the jdbc function calls into"+
		"<y> database commands</y> that can be understood by the underlying database.<br/><br/> With the help of this server, the type 3 driver becomes <y>platform independent.</y></span>"
 ...
 function bridge() {
	 ...
	 zoomInEffect('#bridge',function() {
		...
		var text = "<span class='start-text'>The <y>Type-3 </y> driver also known as the <y>Network-Protocol driver</y>,</span>"
					+ "<span class='end-text'> takes the <y>Jdbc</y> function calls and converts them to "
					+ "<y>vendor-specific database protocol</y>.<br/></span>"		
		popover("#bridge", "left", text,function() {
			$('#popover4').parents(".popover-content").append('<div class = "text-right">'
					+'<span class="introjs-button ct-btn-next" onclick="middleWare();">Next &#8594;</span><div>');
		});
	 });
...
function pipeLineText(selector1, selector2, count, callBackFunction) {
	...
	<div class="col-xs-12 margin-top-20">
		<div class="col-xs-12 text-center">
			<h1 class="label ct-demo-heading">Type - 3 Driver</h1>
		</div>
					...
					<div class="col-xs-12" id="svgParent">
						...
						<div class="col-xs-12 margin-top-20">
							<div id="bridge" class="col-xs-offset-4 col-xs-4  text-center  padding00 border-radius opacity00 z-index">
								...
								<div class="col-xs-12 dash"></div>
								<div class="col-xs-12">Network Protocol (Type-3 Driver)</div>
							</div>
						</div>
						
						<div class="col-xs-12 margin-top-50">
							<div id="middleWare" class="col-xs-offset-4 col-xs-4 border-radius text-center opacity00 z-index">
						...
						<div class="col-xs-12 margin-top-50"></div>
					</div>
				</div>
				<div class="col-xs-5 padding00" id="BrowserTableDiv">
					<div id ="totalPopoverDiv" class="col-xs-12 margin-top-20 padding00"><div id='browserHead' class="col-xs-12 text-center opacity00">Browser</div></div>
					<div class="col-xs-12">
					...
					<div class="col-xs-12 margin-top70 opacity00" id="databaseTable" >
