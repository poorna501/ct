...
<script type="text/javascript" src="/secure/lang/jdbc/js/back.js"></script>
...
<span><g>public</g> <g>class</g> JdbcDemo</span> {
	<span><g>public</g> <g>static</g> <g>void</g> main(String args[]) <g>throws</g> Exception</span> {
		<go>try</go> {
			...
			<span id="ifCond" class="opacity00"><go>if</go> (con != null) {
				<span id="stmt" class="opacity00">Statement stmt = con.createStatement();</span>
				<span id="query1" class="opacity00">String query1 = <ink>"select * from emp"</ink>;</span>
				<span id="eq" class="opacity00">ResultSet rs = stmt.executeQuery(query1);</span>
				<span id="query2" class="opacity00">String query2 = <ink>"update emp table set salary = 400 where empid = 10"</ink>;</span>
				<span id="eu" class="opacity00"><g>int</g> i = stmt.executeUpdate(query2);</span>
				<span id="close" class="opacity00">con.close();</span>
			}</span>
		} <go>catch</go> (SQLException se) {
			se.printStackTrace();
		}
	}
}
	...
	<div class="col-xs-6">
		<div id="animation" class="col-xs-12 padding00 border opcity00" style="height: 600px;">
			...
			<!--  <svg class="svg-css">
				...
				<rect style="fill: rgba(255, 143, 11, 0.15);stroke-width: 2px;stroke: blue;stroke-dasharray: 5;" height="20%" width="57%" y="30%" x="25%"></rect>
				<rect style="fill: orange;stroke-width: 3px;" height="24" width="147" y="14.75%" x="10.2%"></rect>
				<rect style="fill: violet;stroke-width: 2px;stroke: gray;" height="22" width="170" y="60%" x="10%" rx="10" ry="10"></rect>
				
				<circle cx="35%" cy="40%" r="5%" style="stroke: green;stroke-width: 3;fill: lightblue;"></circle>
				<circle cx="50%" cy="40%" r="5%" style="stroke: green;stroke-width: 3;fill: lightblue;"></circle>
				<circle cx="65%" cy="40%" r="5%" style="stroke: green;stroke-width: 3;fill: lightblue;"></circle>
				...
				<text style="font-size: 10px;" x="31%" y="41%" fille="gray">Connection</text>
				<text fille="gray" y="41%" x="46.5%" style="font-size: 10px;">Statement</text>
				<text fille="gray" y="41%" x="61.5%" style="font-size: 10px;">ResultSet</text>
				
			</svg> -->
			
			<!-- <div class="col-xs-12 col-sm-12 col-md-12" style="margin-top:496px;">
				<div class="col-xs-6 padding00">
					<div id="oracleDB" class="col-sm-3 col-md-3 col-xs-offset-3 col-xs-3 database-box oacity00">
			 ...
			 <div class="padding00" style="padding: 15px;height: 450px">
				...
				<div class="col-xs-12 margin-top50">
					<div class="padding00 context opaity00" style=" width:390px;margin-left: 100px;">
