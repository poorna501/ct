...
function javaApi() {
	...
	typing("#popover3", text, function(){
		...
		//revealArrow("svg:eq(0) > line:eq(0)");
		$("svg:eq(0) > line:eq(0)").show()
		TweenMax.to("svg:eq(0) > line:eq(0)", 1, {attr:{x2: "38%", y2: "98%" }, onComplete:function() {
...
function driverManager() {
	...
	typing("#popover4", text, function() {
		...
		//revealArrow("svg:eq(1) line:eq(0)");
		$("svg:eq(1) > line:eq(0)").show()
		TweenMax.to("svg:eq(1) > line:eq(0)", 1, {attr:{x2: "38%", y2: "98%" }, onComplete:function(){
...
function type1() {
	...
	typing("#popover5", text, function() {
		...
		//revealArrow("svg:eq(2) line:eq(0)");
		$("svg:eq(2) > line:eq(0)").show()
		TweenMax.to("svg:eq(2) > line:eq(0)", 1, {attr:{x2: "38%", y2: "98%" }, onComplete:function(){
...
function odbcDriver() {
	...
	typing("#popover6", text, function(){
		...
		$("svg:eq(3) > line:eq(0)").show()
		TweenMax.to("svg:eq(3) > line:eq(0)", 1, {attr:{x2: "38%", y2: "98%" }, onComplete:function(){
...
function databaseLibrary() {
	...
	typing("#popover7", text, function(){
		...
		$("svg:eq(4) > line:eq(0)").show()
		TweenMax.to("svg:eq(4) > line:eq(0)", 1, {attr:{x2: "38%", y2: "98%" }, onComplete:function(){
			...
			//$("#line2").show();							
				//TweenMax.to("#line2", 1, {attr:{x2: "60%", y2: "1%" }, onComplete:function(){
					...
					typing("#popover8", text, function() {
						...
						setTimeout(function() {
							//TweenMax.to("#line2", 1, {attr:{x2: "60%", y2: "1%" }, onComplete:function(){
								$("svg:eq(4) > line:eq(1)").show();
								TweenMax.to("svg:eq(4) > line:eq(1)", 1, {attr:{x2: "60%", y2: "2%" }, onComplete:function() {
									$("svg:eq(3) > line:eq(1)").show();
									TweenMax.to("svg:eq(3) > line:eq(1)", 1, {attr:{x2: "60%", y2: "2%" }, onComplete:function() {
										$("svg:eq(2) > line:eq(1)").show();
										TweenMax.to("svg:eq(2) > line:eq(1)", 1, {attr:{x2: "60%", y2: "2%" }, onComplete:function() {
											$("svg:eq(1) > line:eq(1)").show();
											TweenMax.to("svg:eq(1) > line:eq(1)", 1, {attr:{x2: "60%", y2: "2%" }, onComplete:function() {
												$("svg:eq(0) > line:eq(1)").show();
												TweenMax.to("svg:eq(0) > line:eq(1)", 1, {attr:{x2: "60%", y2: "2%" }, onComplete:function() {
													$('#popover8').parents(".popover-content").append('<div class = "tooltip-height"><span class="btn-success ct-btn-next" onclick="a();">Next &#8594;</span><div>');
												}})
											}})
										}})
	...
	<div class="col-xs-offset-1 col-xs-9 main-div text margin-top20"
		...
		<div class="col-xs-offset-4 col-xs-8 animation-div border margin-top20"
			...
			<div class="col-xs-12 margin-top20">
				...
				<svg width="100%" height="45" class="col-xs-offset-4 col-xs-4 text">
						...
						orient="auto" style="fill: gray;" id="arrow">
							<path d="M0,0 L5,2.5 L0,5 Z" class="arrow" />
								...
								<line class="line svg-line" id="" x1="38%" y1="0%" x2="38%" y2="2%"
						style="marker-end: url(#arrow); stroke: gray; stroke-width: 2" />
										<line class="line svg-line" id="" x1="60%" y1="100%" x2="60%" y2="100%"
							style="marker-end: url(#arrow); stroke: gray; stroke-width: 2" />	
				</svg>
			</div>
				
				<div class="col-xs-offset-4 col-xs-4 text">
					<div class="border text-center margn-top20 opacity00" id="jdbcApiBox"
				...
				<div class="col-xs-12 margin-top20" style="margin: 0px;">
					<svg width="100%" height="30" class="col-xs-offset-4 col-xs-4 text">
								<marker refX="4" refY="2.5" markerWidth="5" markerHeight="5"
							orient="auto" style="fill: gray;" id="arrow">
								<path d="M0,0 L5,2.5 L0,5 Z" class="arrow" />
								</marker>
									<line class="line" id="" x1="38%" y1="0%" x2="38%" y2="2%"
							style="marker-end: url(#arrow); stroke: gray; stroke-width: 2" />
											<line class="line" id="" x1="60%" y1="100%" x2="60%" y2="100%"
								style="marker-end: url(#arrow); stroke: gray; stroke-width: 2" />	
					</svg>
				</div>
				
				<div class="col-xs-12 marin-top20">
					<div class="col-xs-offset-4 col-xs-4 text">
						<div class="border text-center magin-top20 opacity00" id="managerBox"
							style="background-color: lightyellow;">
			...
			<div class="col-xs-12 margin-top20" style="margin: 0px;">
				<svg width="100%" height="35" class="col-xs-offset-4 col-xs-4 text">
							<marker refX="4" refY="2.5" markerWidth="5" markerHeight="5"
						orient="auto" style="fill: gray;" id="arrow">
							<path d="M0,0 L5,2.5 L0,5 Z" class="arrow" />
							</marker>
			...
			<div class="col-xs-12  magin-top20">
				<div class="col-xs-offset-4 col-xs-4 text">
