	...
	svgLineTopAndBottom("#driverOne","#oDriver","#DLApi" ,"line5","grey", "bottom","top", "left", "left", "", function() {
		zoomInEffect('#DLApi',function() {
			...
			popover("#DLApi", "left", text,function() {
				popoverGrayOut();
				svgLineTopAndBottom("#driverOne","#DLApi","#ovalShape" ,"line6","grey", "bottom","top", "left", "left", "", function() {
					zoomInEffect('#database',function() {
						...
						popover("#database", "left", text,function() {
							svgLineTopAndBottom("#driverOne","#ovalShape" ,"#DLApi" ,"line7","grey", "top","bottom", "right", "right", "", function() {
...
function database() {
	popoverGrayOut();
	$('#popover1').append("<span id='advantages'></span>");
	var text = "<br><b>Advantages :</b> <br>------------------<br> Connect to almost any database on any system, for which ODBC driver is installed.</br>" 
		+ "<br><b>Disadvantages :</b><br>-----------------------<br> 1. Performance overhead since the calls have to go through the "
		+ "JDBC bridge to the ODBC driver, then to the" 
	...
	typing("#advantages", text, function() {
		$('#restartDiv').removeClass('hide');
		$('#popover1').parents(".popover-content").append('<div class = "text-right">'
				+'<span class="introjs-button ct-btn-next" onclick="nextStep();">Next &#8594;</span><div>');
	});
}
