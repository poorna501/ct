...
function initIntroJs() {
	...
	introjs.onafterchange (function(targetElement) {
		...
		switch(elementId) {
		case "driverOne":
			var text = "The <y>JDBC Type-1 driver</y> is also known as the <b>JDBC-ODBC Bridge Driver.</b><br> <span><span id ='jdbc'>Here,<br> "
...
function client() {
 ...
 function bridge() {
	 ...
	 zoomInEffect('#bridge',function() {
		...
		"<span class='end-text'> takes the <y>Jdbc</y> function calls and converts them to <y>ODBC</y> function calls ."+
		"<br/><br/>These <y>ODBC</y> calls are then sent  to the ODBC driver to communicate to the database.</span>"		
