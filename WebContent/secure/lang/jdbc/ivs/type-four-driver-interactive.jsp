...
function responseArrowAnimaiton() {
	...
	tube2("#ovalShape", "#bridge", "tubeLine12");
	tube1("#ovalShape", "#bridge", "tubeLine11");
	setTimeout(function() {
		pipeLineText("#ovalShape", "#bridge", 0);
		setTimeout(function() {
...
function pipeLineText(selector1, selector2, count, callBackFunction) {
	...
	<div class="col-xs-12 margin-top-20">
		<div class="col-xs-12 text-center">
			<h1 class="label ct-demo-heading">Type-4 Driver</h1>
		</div>
