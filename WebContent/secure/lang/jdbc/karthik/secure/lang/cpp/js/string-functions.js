...
function introGuide() {
	...
	introjs.onbeforechange(function(targetElement) {
		...
		case 'line1':
			...
			$("#arrayDiv, #aArrayDiv, #bArrayDiv, #cArrayDiv").addClass('opacity00');
			$("#indices, #arrayBox1, #arrayBox2, #arrayBox3").empty();
			break;
		case 'line2':
			...
			break;
		case 'line6':
			$("#printText2").empty().addClass("visibility-hidden");
			//$("#functionDiv").addClass("opacity00");
			/*$('.introjs-helperLayer').one('transitionend', function() {
		...
		case 'line12':
			...
			break;
		case 'line4':
			$('.input-text').removeAttr('contenteditable placeholder');
			$("#inputText").removeClass("blink").text('');
		...
		case 'line10':
			$("#inputTextTwo").text("");
			$('.input-text-two').removeAttr('contenteditable placeholder');
			$("#inputTextTwo").removeClass("blink");
			/*$('.introjs-helperLayer').one('transitionend', function() {
				var typingContent = "<span class='ct-code-b-yellow'>cin</span> is used to read a string from the keyboard.";
				typing('.introjs-tooltiptext', typingContent, typingInterval, 'white', function() {
					$(".introjs-nextbutton, .introjs-prevbutton").show();
		...
		case 'arrayDiv':
			...
			case 'copyText':
				...
				$('.introjs-helperLayer').one('transitionend', function() {
					...
					"<span class='ct-code-b-yellow'>b</span>.";
					typing('.introjs-tooltiptext', typingContent, typingInterval, 'white', function() {	
						$(".introjs-tooltipbuttons").append("<a class='introjs-button user-btn opacity00'>Next &#8594;</a>");
						setTimeout(function() {
							$(".user-btn").click();
						}, 500);
						$(".user-btn").click(function() {
