...
<script src="/secure/lang/cpp/js/string-functions.js" ></script>
...
<in>#include</in> <ink>&lt;string.h&gt;</ink>
<span><go>using namespace</go> std;</span>
<g>int</g> main () {
	<span id="line1"><g>char</g> a[<ink>20</ink>], b[<ink>20</ink>], c[<ink>20</ink>];</span>
	<span id="line2"><g>int</g> length, i;</span>
	<span id="line3">cout &lt;&lt; <ink>"Enter a string :"</ink>;</span>
	<span id="line4">cin >> a;</span>
	<span id="line5">length = strlen(a);</span>
	<span id="line6">cout << <ink>"The length of the string "</ink> << a << <ink>" is "</ink><< length <<"<in>\n</in>";</span>
	<span id="line7">strcpy(b, a);</span>
	<span id="line8">cout << <ink>"The copied string = "</ink> << b << "<in>\n</in>";</span>
	<span id="line9">cout << <ink>"Enter the second string :"</ink>;</span>
	<span id="line10">cin >> c;</span>
	<span id="line11">strcat(a, c);</span>
	<span id="line12">cout << <ink>"The concatenated string = "</ink> << a << "<in>\n</in>";</span>
	<span id="line13">i=strcmp(b, c);</span>
	<span id="line14"><go>if</go>(i == <ink>0</ink>) {
		cout << <ink>"The given two strings are equal"</ink> << "<in>\n</in>";</span>
	} <span id="line15"><go>else if</go>(i > <ink>0</ink>) {
		cout << <ink>"The string "</ink> << b << <ink>" is higher than the string "</ink> << c << "<in>\n</in>";</span>
	} <span id="line16"><go>else</go> {
		cout << <ink>"The string "</ink> << c << <ink>" is higher than the string "</ink> << b << "<in>\n</in>";</span>
	}
}
</pre>
		</div>
