		...
		introjs.onbeforechange(function(targetElement){
			...
			switch (elementId) {
				...
				case "algorithmDiv":
					...
					$("#algorithmDiv, #enterArmstrongNumber, #StoreValueInToTemp, #whileLoop1").addClass("opacity00");
			...
			$('.introjs-helperLayer').one('transitionend', function() {
				...
				typing('#enterArmstrongNumber', text, typingInterval, 'white', function() {
					...
					text = 'Here, we are declaring and initializing the integer variables '+
							...
							'<span class="ct-code-b-yellow">temp</span> and '+
						...
						flipEffectWithTweenMax("#whileNumber"+count, parseInt(number), function() {
							if (parseInt(number) != 0) {
								...
								typing("#trueOrFalse"+count, text, typingInterval, 'white', function() {
									...
									/* $('.introjs-tooltip').removeClass('hide');
									text = 'Since, the condition evaluates to <span class="ct-code-b-yellow">true</span>, '+
										'the control enters into <span class="ct-code-b-yellow">while-body</span>';
									typing('.introjs-tooltiptext', text, typingInterval, 'white', function() {
										$('.introjs-tooltipbuttons').append("<a class='introjs-button introjs-duplicate-nextbutton' " +
										"onclick=remainderAnimation("+ count +");>Next &#8594;</a>");
									}); */
								});
							} else {
					...
					setTimeout(function() {
						...
						$("#moduloNumberSpan"+count).effect("highlight", {color: '#4d4dff'}, 500, function() {
							flipEffectWithTweenMax("#moduloNumberSpan"+count, parseInt(remainder), function() {
								...
								/* $('.introjs-tooltip').removeClass('hide');
								text = 'Now, the value of the variable <span class="ct-code-b-yellow">remainder</span> is '+
									'<span class="ct-code-b-yellow">'+ parseInt(remainder) +'</span>.'+
									'<br><span id = "valueOfNumber"></span>';
								typing('.introjs-tooltiptext', text, typingInterval, 'white', function() {
									$('.introjs-tooltipbuttons').append("<a class='introjs-button introjs-duplicate-nextbutton' " +
									"onclick=numberAnimation("+ count +");>Next &#8594;</a>");
								}); */
							});
						});
					},300);
					...
					setTimeout(function() {
						number = parseInt(number) / 10;
							...
							flipEffectWithTweenMax("#divideNumberSpan"+count, parseInt(number), function() {
								sumAnimation(count);
								/* $('.introjs-tooltip').removeClass('hide');
								text = 'Now, the value of the variable <span class="ct-code-b-yellow">number</span> is '+
									'<span class="ct-code-b-yellow">'+ parseInt(number) +'</span>.'+
									'<br><span id = "valueOfSum"></span>';
								typing('#valueOfNumber', text, typingInterval, 'white', function() {
									$('.introjs-tooltipbuttons').append("<a class='introjs-button introjs-duplicate-nextbutton' " +
									"onclick=sumAnimation("+ count +");>Next &#8594;</a>");
								}); */
							});
						});
					},300);
							...
							flipEffectWithTweenMax("#sumValue"+count, sum, function() {
								...
								$("#calculateSumSpan"+count).effect("highlight", {color: '#4d4dff'}, 500, function() {
									flipEffectWithTweenMax("#calculateSumSpan"+count, sum, function() {
										...
										/* $('.introjs-tooltip').removeClass('hide');
										text = 'Now, the value of the variable <span class="ct-code-b-yellow">sum</span> is '+
											'<span class="ct-code-b-yellow">'+ sum +'</span>.<br/><br/>'+
											'Again checks the while condition'+
											'<br><span id = "againCheckWhileLoop"></span>';
										typing('#valueOfSum', text, typingInterval, 'white', function() {
											$('.introjs-tooltipbuttons').append("<a class='introjs-button introjs-duplicate-nextbutton' " +
											"onclick=armstrongNumberAnimation("+ ++count +");>Next &#8594;</a>");
										});*/
									}); 
								});
							});
