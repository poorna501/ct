	...
	introcode.onbeforechange(function(targetElement) {
		...
		case "enterLine1":
			...
			if (introcode._direction == "backward") {
				...
				/*$("#firstNum").removeAttr("contentEditable").html('&nbsp;');*/
		...
		case "senterLine1":
			if (introcode._direction == "backward") {
					...
					/*$("#firstNum1").removeAttr('contentEditable').html('&nbsp');*/
		...
		case "outputDiv":
			...
			if (introcode._direction == "backward") {
				if (introcode._currentStep == 11 ) {
					...
					$('#outputAValue3').addClass('opacity00');
					/*$("#firstNum1").removeAttr('contentEditable').html('&nbsp;');*/
					$("#firstNum1").removeAttr('contentEditable').text('');
					if (introcode._direction == "backward") {
						introcode._introItems.splice(introcode._introItems.length - 1);
					}
...
function dynamicStep3() {
	...
	/*var dynamicStep1 = {
		...
		introcode.insertOption(introcode._currentStep + 3, dynamicStep1);*/
}
	...
	if (if1 == 1) {
		...
		TweenMax.fromTo("#false1",0.5,{rotationX:-90},{delay : 0.5, rotationX:0,opacity: 1,onComplete:function() {
			...
			/*$('.animation-nextbtn').click(function(){ 
				 ...
				 introcode.insertOption(introcode._currentStep + 1, insertionIntro("elseifline2", "", "right", ""));
			});*/
		}});
	} 
}
	...
	if (if1 == 2) {
		...
		TweenMax.fromTo("#false1",0.5,{rotationX:-90},{delay : 0.5, rotationX:0,opacity:1,onComplete:function() {
			...
			/*$('.animation-nextbtn').click(function(){ 
				...
				introcode.insertOption(introcode._currentStep + 1, insertionIntro("elseifline3", "", "right", ""));
			});*/
		}});
	} 
}
	...
	if (if1 == 3) {
		...
		TweenMax.fromTo("#false1",0.5,{rotationX:-90},{delay : 0.5, rotationX:0,opacity:1,onComplete:function() {
			...
			$('.animation-nextbtn').click(function(){ 
				...
				introcode.insertOption(introcode._currentStep + 1, insertionIntro("elseifline4", "", "right", ""));
			});*/
		}});
	} 
}
...
function switchCondition() {
	...
	if (switchnumber < 4) {
		$('#n'+switchnumber).effect("highlight", {color: 'blue'}, 2000, function() {
			/*dynamicStep2("#cas"+switchnumber,"#ssopLine"+switchnumber, "#breakline"+switchnumber, switchnumber);*/
			dynamicStep2("#cas"+switchnumber,"#ssopLine"+switchnumber, switchnumber);
			$('.introjs-nextbutton, .introjs-prevbutton').show();
		});
	} else {
...
function outputShow(text) {
	...
	$(".introjs-helperLayer").one("transitionend", function() {
		setTimeout(function() {
			...
			//introcode.goToStep(17); outpuDiv
			stepNext();
		}, 1000);
	});
}
