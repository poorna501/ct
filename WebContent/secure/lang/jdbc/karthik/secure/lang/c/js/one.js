...
function introJsGuide() {
	...
	introjs.onafterchange(function(targetElement) {
		...
		switch (elementId) {
	case "intitialization":
		var text = "<span>This is the <span class = ct-code-b-yellow>initialization</span>"
					+" section.<br>Here, the local variable <span class = 'ct-code-b-yellow "
					+"codeText'>i</span> is initialized to <b class='codeText'>0</b>.<br> You "
					+"can also change the value <b class='codeText'>0</b> to any other number."
					+"</span><span id='initialization_Text'></span>"
	break;
		}
		})
	...
	var text = "<span>Above code demonstrates the working of a <span class = ct-code-b-yellow>for-loop</span>.</span>";
