...
<title>Delete-at-begin-method-in-DCLL</title>
...
<script src="js/delete-at-begin-in-dcll.js"></script>
		...
		<div class='col-xs-12 padding00'>
			<div class="ct-box-main">
				<div class='text-center'>
					<h4 class='label ct-demo-heading' id='headingDiv'>deleteAtBegin() in Doubly Circular Linked List</h4>
				</div>
			</div>
										...
										<div class="col-xs-2 padding00 opacity00 position" id="firstNode">
											<div class="text-center col-xs-12 padding00" id="firstLabel">first</div>
												...
												<div class="col-xs-6 padding00 text-center">
													<span id="dataAddressDummy" class="position  ct-brown-color ct-fonts opacity00">2318</span>
												</div>
											</div>
										</div>
