...
<title>Delete-at-end-method-in-DCLL</title>
...
<script src="js/delete-at-end-in-dcll.js"></script>
		...
		<div class='col-xs-12 padding00'>
			<div class="ct-box-main">
				<div class='text-center'>
					<h4 class='label ct-demo-heading' id='headingDiv'>deleteAtEnd() in Doubly Circular Linked List</h4>
				</div>
			</div>
