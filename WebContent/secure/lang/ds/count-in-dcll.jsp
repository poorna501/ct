...
<script src="js/count-in-dcll.js"></script>
<style type="text/css">
		...
		<div class='col-xs-12 padding00'>
			<div class="ct-box-main">
				<div class='text-center'>
					<h4 class='label ct-demo-heading' id='headingDiv'>count() in Doubly Circular Linked List</h4>
				</div>
			</div>
								...
								<div class='col-xs-12 margin-top-25 margin-bottom-25 padding00'>
									<div class="col-xs-12">
										...
										<div class="col-xs-10" id="sumValDiv">
											<div class="col-xs-3 text-center opacity00" id="sumVar">count = <span id="sum" class="position">0</span></div>
										</div>
									</div>
								</div>
										...
										<div class="col-xs-2 padding00 opacity00 position" id="firstNode">
											<div class="text-center col-xs-12 padding00" id="firstLabel">first</div>
												...
												<div class="col-xs-6 padding00 text-center">
													<span id="dataAddress11" class="position  ct-brown-color ct-fonts opacity00">2318</span>
												</div>
											</div>
										</div>
									</div>
