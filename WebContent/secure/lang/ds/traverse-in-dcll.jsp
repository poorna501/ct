...
<script src="js/traverse-in-dcll.js"></script>
<style type="text/css">
		...
		<div class='col-xs-12 padding00'>
			<div class="ct-box-main">
				<div class='text-center'>
					<h4 class='label ct-demo-heading' id='headingDiv'>traverse() in Doubly Circular Linked List</h4>
				</div>
			</div>
